...
class DataLogger(Node):
    ...
    def __init__(self, args):
        ...
        self.log_file.write('crashes\n') #An added value for the crashes detected
        self.log_file.flush()        
        ...
        #Subscribes to each robot's crash counter topic,
        #When a msg is published to the topic, a crash is added to the counter
        #An imperfect system, as crashes are sometimes counted multiple times
        self.robot_subscriptions = []
        for i in range(NUM_ROBOTS):
            namespace = 'robot' + str(i + 1) + '/crash_counter'
            self.robot_subscriptions.append(self.create_subscription(
                CrashCheck, namespace, self.crash_counter_callback, 10))

        self.crash_counter = 0
        
    def crash_counter_callback(self, msg):
    ...
    def item_log_callback(self, msg):
        ...
        self.log_file.write(f'{self.crash_counter}\n')
        self.log_file.flush()
        self.counter += 1
