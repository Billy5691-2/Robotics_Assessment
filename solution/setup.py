...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'robot_tracker = solution.robot_tracker:main',
            'robot_targets = solution.robot_targets:main',
            'robot_item_tracker = solution.robot_item_tracker:main',
            'robot_crash_detection = solution.robot_crash_detection:main',
            'robot_collision_warning = solution.robot_collision_warning:main'
        ],
    },
)
